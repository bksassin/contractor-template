          ...
          <form   action="submit" method="POST" className="space-y-8">
            ...
            <div>
              ...
              >
                ...
                <option value="Paint">Oil Change</option>
                <option value="Flooring">Brakes</option>
                <option value="Fence/Patio">Tires</option>
                <option value="Rehab">Diag</option>
  ...
  <div className="flex items-center mb-2">
    ...
    <label htmlFor="phoneCall" className="text-sm font-medium text-gray-900">
      Do you want us to schedule a phone call?
            ...
            <button class="bg-[#0a58d7] hover:bg-[#0a58d7] hover:bg-opacity-90 text-white font-bold py-2 px-4 rounded">
  Submit
</button>
          </form>
        </div>
